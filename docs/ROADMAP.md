...
| Week 5a | 탭 구조 리팩 + 뉴스 소스 다변화 + 경제 탭 강화 | 2탭(시사/경제) 안정화 | 종목 격하, Google News RSS, 국내/해외 2옵션 필터, 경제 뉴스 요약 노출 |
| Week 5b | AI 탭 + default 전환 | 3탭(AI/시사/경제), default=AI | AI 모델·툴·디자인 소식, GeekNews + YouTube + HN + 공식 블로그 |
| Week 6 | 펀더멘털 발굴 트랙 | 이벤트 무관 저평가·우량·성장 발굴 | 고정 유니버스(미국·코스피) 정량 스크린(가치·퀄리티·성장) + LLM 리서치, 온디맨드 `screen`, '발굴' 탭, 알파 성과 원장 (`DECISIONS.md` #19) |
